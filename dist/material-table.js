  ...
  function MaterialTable(_props) {
      ...
      function (mode, rowData) {
        if (mode === 'add') {
          _this.props.editable.onRowAddCancelled &&
            _this.props.editable.onRowAddCancelled(rowData);
          _this.setState({
            showAddRow: false
          });
        } else if (mode === 'update') {
          _this.props.editable.onRowUpdateCancelled &&
            _this.props.editable.onRowUpdateCancelled(rowData);
          _this.dataManager.changeRowEditing(rowData);
          _this.setState(_this.dataManager.getRenderState());
        } else if (mode === 'delete') {
          _this.props.editable.onRowDeleteCancelled &&
            _this.props.editable.onRowDeleteCancelled(rowData);
          _this.dataManager.changeRowEditing(rowData);
          _this.setState(_this.dataManager.getRenderState());
        }
      }
    ...
    (0, _defineProperty2['default'])(
      ...
      function (path, render) {
        ...
        _this.setState(_this.dataManager.getRenderState());
        _this.props.onTreeExpandChange &&
          _this.props.onDetailPanelChange(
            row,
        ...
        props.options.header &&
          /*#__PURE__*/ _react['default'].createElement(
            props.components.Header,
            {
              ...
              sorting:
                props.options.sorting || _this.dataManager.maxColumnSort !== 0,
