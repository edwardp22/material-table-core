          ...
          function (result, currentRow) {
            ...
            object = groups.reduce(function (o, colDef) {
              ...
              if (!group) {
                ...
                var _isDefaultExpanded = false;
                switch ((0, _typeof2['default'])(_this4.defaultExpanded)) {
                  case 'boolean':
                    _isDefaultExpanded = _this4.defaultExpanded;
                    break;
                  case 'function':
                    _isDefaultExpanded = _this4.defaultExpanded(currentRow);
                    break;
                }
