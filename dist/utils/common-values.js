...
var actionsColumnWidth = (exports.actionsColumnWidth =
  function actionsColumnWidth(props) {
...
var reducePercentsInCalc = (exports.reducePercentsInCalc =
  function reducePercentsInCalc(calc, fullValue) {
...
var parseFirstLastPageButtons = (exports.parseFirstLastPageButtons =
  function parseFirstLastPageButtons(showFirstLastPageButtons, isRTL) {
    var result = {
      first: true,
      last: true
    };
    if (typeof showFirstLastPageButtons === 'boolean') {
      ...
      (0, _typeof2['default'])(showFirstLastPageButtons) === 'object'
    ) {
