...
function MTableBodyRow(_ref) {
  ...
  var propsWithOptions = _objectSpread(
    _objectSpread({}, props),
    {},
    {
      options: options
  ...
  var _props$data = props.data,
    ...
    persistEvents =
      _props$persistEvents === void 0 ? false : _props$persistEvents,
    ...
    var mapArr = columns
      ...
      .map(function (columnDef) {
        ...
        if (
          ...
          data.tableData.editCellList.find(function (c) {
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    data.tableData.childRows &&
      ...
      data.tableData.childRows.map(function (data, index) {
...
MTableBodyRow.propTypes = {
  ...
  path: _propTypes['default'].arrayOf(
    _propTypes['default'].oneOfType([
...
var _default = (exports['default'] = /*#__PURE__*/ _react['default'].forwardRef(
  function MTableBodyRowRef(props, ref) {
    return /*#__PURE__*/ _react['default'].createElement(
      MTableBodyRow,
      (0, _extends2['default'])({}, props, {
        forwardedRef: ref
