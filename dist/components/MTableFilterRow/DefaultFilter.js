...
var _InputAdornment2 = _interopRequireDefault(
  ...
  return /*#__PURE__*/ _react['default'].createElement(_TextField2['default'], {
    ...
    style:
      columnDef.type === 'numeric'
        ? {
            float:
              (_columnDef$align = columnDef.align) !== null &&
              _columnDef$align !== void 0
                ? _columnDef$align
                : 'right'
          }
        : {
            float:
              (_columnDef$align2 = columnDef.align) !== null &&
              _columnDef$align2 !== void 0
                ? _columnDef$align2
                : 'left'
          },
...
var _default = (exports['default'] = /*#__PURE__*/ _react['default'].forwardRef(
  function DefaultFilterRef(props, ref) {
