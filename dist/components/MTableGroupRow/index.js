...
function MTableGroupRow(_ref) {
      ...
      if (groupData.data.length) {
        ...
        groupData.groups.forEach(function (group) {
          var _mapSelectedRows = mapSelectedRows(group),
            _mapSelectedRows2 = (0, _slicedToArray2['default'])(
              _mapSelectedRows,
              2
            ),
  ...
  if (options.showGroupingCount) {
    ...
    value += ' ('.concat(
      (_props$groupData$data =
        (_props$groupData$data2 = props.groupData.data) === null ||
        _props$groupData$data2 === void 0
          ? void 0
          : _props$groupData$data2.length) !== null &&
        _props$groupData$data !== void 0
        ? _props$groupData$data
        : 0,
      ')'
    );
...
var _default = (exports['default'] = /*#__PURE__*/ _react['default'].forwardRef(
  function MTableGroupRowRef(props, ref) {
    return /*#__PURE__*/ _react['default'].createElement(
      MTableGroupRow,
